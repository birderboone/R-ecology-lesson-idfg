...
*Useful*  
- Swirl - R package used to get you started on beginner stuff. This might be a good one to 
remind you what it is we did today
- R for Data Science - Next step - intermediate level - learning. Takes a unique view on teaching R. Starts with visualization before cleaning. Good place to start after this clase
[R for Data Science](https://r4ds.hadley.nz/)
- Coursea - Can be difficult to grasp as a beginner, after this course you should be able to handle it much ebtter with ease. More course centric approach if thats what you need
...
```
Idk what this is, but carpentries supposedly likes it for teaching programming.
